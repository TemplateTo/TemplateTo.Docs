...
On templates you want to apply your default theme to, go to [template settings](../creating/settings.md#enable-theme) and enable themes. This will update the editor and apply the theme during generation.
