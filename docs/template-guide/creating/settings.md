...
[Theme documentation](../dynamic-content/themes.md)

## PDF Settings

Numerous settings you can apply to your PDF. For detailed PDF-specific documentation, see [PDF Generation](../output-formats/pdf.md).
