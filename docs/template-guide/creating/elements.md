...
| Item                                                       | Description                                            |
| ---------------------------------------------------------- | ------------------------------------------------------ |
| [Text](#text)                    | Simple WYSIWYG text element                            |
| [Image](#image)                  | Add images to your template                            |
| [Content Block](#content-blocks) | Content blocks are reusable content. See more details. |
| [Page Break](#page-break)        | Add a Page Break to your template                      |
| [Header](#header)                | Simply adds a heading section                          |
| [Table](#table)                  | Add a table to the editor                              |
|                                                            |                                                        |

### Text

This element puts a WYSIWYG editor onto your template, you can style the text within the element using the tools in the [Editor window](../editor-overview.md#editor-window)
...
!!! note
    It might be helpful to have data added to your template when working with the Condition element. [Learn more here](../dynamic-content/variables.md)
